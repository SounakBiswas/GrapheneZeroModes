  ...
  for(i=0;i<nsites;i++){
    if(   (ifvac[i]!=1) && (burn[i]==-1)){
      ...
      while(pck_counter!=-1){
        ...
        //printf("pc %d site %d vstat %d\n",pck_counter,site, ifvac[site]);
        pck_counter--;
        clust_counter++;
        burn[site]=n_clust;
        sublat=site%2;
        ...
        if(ifvac[site]<=0){  //free clusters
          ...
          site2=neigh[site][2];
          if( (ifvac[site2]<=0) &&(burn[site2]==-1)&& !((x==0)&&(sublat=0)) && !((x==lx-1)&&(sublat=1))){
            pck_counter++;
            pocket[pck_counter]=site2;
            burn[site2]=n_clust;
          }
        ...
        if(ifvac[site]==2){  //free clusters
          ...
          site2=neigh[site][2];
          if( (ifvac[site2]==3) &&(burn[site2]==-1)&& !((x==0)&&(sublat=0)) && !((x==lx-1)&&(sublat=1))){
            pck_counter++;
            //printf("padd\n");
            pocket[pck_counter]=site2;
            burn[site2]=n_clust;
        ...
        if(ifvac[site]==3){  //free clusters
          ...
          site2=neigh[site][2];
          if( (ifvac[site2]==2) &&(burn[site2]==-1)&& !((x==0)&&(sublat=0)) && !((x==lx-1)&&(sublat=1))){
            pck_counter++;
            pocket[pck_counter]=site2;
            burn[site2]=n_clust;
          }
